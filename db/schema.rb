...
ActiveRecord::Schema.define(version: 20161024124043) do
  ...
  create_table "rows", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["project_id"], name: "index_rows_on_project_id", using: :btree
  end
  ...
  add_foreign_key "components", "rows"
  add_foreign_key "projects", "users"
  add_foreign_key "rows", "projects"
end
